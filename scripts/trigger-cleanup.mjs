const FUNCTION_URL = 'https://kxjwssyacuxvtlvszgse.supabase.co/functions/v1/cleanup-storage';
...
async function trigger() {
  console.log(`Triggering cleanup for ${orphans.length} files...`);
  ...
  try {
    ...
    if (data.success) {
      console.log('\n✅ STORAGE CLEANUP INITIATED SUCCESSFULLY!');
    } else {
