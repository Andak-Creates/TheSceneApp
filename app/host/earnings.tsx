...
export default function HostEarningsScreen() {
  ...
  const fetchEarningsData = async () => {
    ...
    try {
      ...
      setBalance(balanceData || { total_earned: 0, total_withdrawn: 0, current_balance: 0, currency: "NGN" });
  ...
  return (
    <View className="flex-1 bg-[#191022]">
      ...
      <View className="pt-12 px-6 pb-4 flex-row items-center border-b border-white/10">
        ...
        <Text className="text-white text-xl font-bold flex-1">Earnings & Payouts</Text>
      </View>
        ...
        ListHeaderComponent={
          <View className="p-6">
            ...
            <View className="bg-purple-600 rounded-3xl p-6 mb-8 shadow-lg shadow-purple-600/20">
              <Text className="text-purple-200 text-sm font-semibold mb-1">Available Balance</Text>
              ...
              <View className="flex-row gap-4">
                ...
                <TouchableOpacity 
                  ...
                  className={`flex-1 py-3 rounded-xl items-center ${
                    !balance || balance.current_balance <= 0 ? "bg-white/10" : "bg-white"
                  }`}
                >
                  <Text className={!balance || balance.current_balance <= 0 ? "text-white/30" : "text-purple-600 font-bold"}>
                    Withdraw
                  </Text>
                </TouchableOpacity>
              </View>
